...
class TrustListener(stomp.ConnectionListener):
    ...
    def on_message(self, frame):
        try:
            ...
            for message in data:
                # TRUST messages typically nest the event attributes inside a 'body' key
                ...
                if train_id:
                    ...
                    st.session_state.movements.insert(0, movement_record)
...
def run_trust_client():
    ...
    try:
        ...
        st.session_state.connection_status = "Connected to TRUST Feed!"
...
if st.session_state.movements:
    ...
    st.info(
        "Listening for live train movement reports... (Movements may take a brief moment to appear depending on active network traffic).")
